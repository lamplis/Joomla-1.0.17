...
if (!defined('_ADMIN_OFFLINE') || defined('_INSTALL_CHECK'))
{
	...
	<head>
		...
		if (file_exists("$mosConfig_absolute_path/templates/$cur_template/css/offline.css"))
		{
			?>
			<link rel="stylesheet"
			      href="<?php echo $mosConfig_live_site; ?>/templates/<?php echo $cur_template; ?>/css/offline.css"
			      type="text/css"/>
		<?php
		}
	...
	<table width="550" align="center" class="outline">
		<tr>
			<td width="60%" height="50" align="center">
				<img src="<?php echo $mosConfig_live_site; ?>/images/joomla_logo_black.jpg" alt="Joomla! Logo"
				     align="middle"/>
			</td>
		</tr>
		<tr>
		...
		else if (@$mosSystemError)
		{
			...
			<tr>
				<td width="39%" align="center">
					...
					<span
						class="err"><?php echo defined('_SYSERR' . $mosSystemError) ? constant('_SYSERR' . $mosSystemError) : $mosSystemError; ?></span>
				</td>
			</tr>
		<?php
		}
